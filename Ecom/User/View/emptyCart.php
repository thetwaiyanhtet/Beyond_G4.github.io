...
<span class="flex items-center  mb-[1%]">
 ...
 <section class="relative">
  <section class="w-screen  h-screen rounded-tl-[50px] rounded-tr-[50px] flex justify-center align-middle items-center
   bg-gradient-to-tl from-purple-400 via-purple-400 to-purple-500">
     <section class="flex flex-col items-center">
      <img src="../View/resources/img/empty cart.png" alt="">
     </section>
     
  </section>
  <ion-icon  class="text-5xl absolute left-14 bottom-36 cursor-pointer max-md:text-3xl max-md:left-8 max-md:bottom-24" 
