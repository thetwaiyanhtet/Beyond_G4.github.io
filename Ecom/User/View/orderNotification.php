...
<body class="mt-3 font-Philosopher overflow-hidden dark:bg-black">
    ...
    <section class="relative">
        <section class=" w-screen h-screen pt-5 rounded-tl-[5%] flex flex-col  justify-start align-middle items-center bg-gradient-to-tl from-[#d5a0e6] - to-[#9f80f4] dark:bg-linear_dark ">
