...
<body>
    ...
    <div class="flex flex-col items-center">
        ...
        <form action="../Controller/updatePasswordController.php" method="post" class="mt-10">
            <label for="newPw"class="font-poppins text-base dark:text-black text-black md:ml-5">New Password</label><br><br>
            ...
            <button type="submit" name="changePw" class="bg-btn-color text-white font-poppins md:w-40 w-32 p-2 rounded-lg mt-10 font-semibold text-lg absolute md:right-5 right-8">Verify</button>
            </div>
        </form>
    </div>
</body>
