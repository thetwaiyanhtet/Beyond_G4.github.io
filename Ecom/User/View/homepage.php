    ...
    <div class="main_bdy z-1 ">
        <div class="left_side">
            ...
            <div class="btn_s absolute bottom-20 md:bottom-48 left-16 md:left-36 z-20">
                ...
                <div data-popover id="popover-image" role="tooltip" class="absolute z-10 invisible inline-block text-sm text-gray-400 transition-opacity duration-300 bg-gray-800 border border-gray-200 rounded-lg shadow-sm opacity-0 w-96 dark:text-gray-500 dark:bg-white dark:border-gray-600">
                    <div class="grid grid-cols-5">
                        <div class="col-span-5 p-3">
                            <div class="space-y-2">
                                <h3 class="font-semibold text-black dark:text-black">Beyond Evolution</h3>
                                ...
                                <a href="./aboutUs.php" class="flex items-center font-medium text-black dark:hover:text-pink hover:text-pink-900">Read more <svg class="w-2 h-2 ml-1.5" aria-hidden="true" fill="none" viewBox="0 0 6 10">
