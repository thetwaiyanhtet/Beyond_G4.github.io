...
<body class=" bg-violet-200 font-philosopher letter relative overflow-hidden">
    <main class=" min-h-screen flex items-center justify-center">
        ...
        <div class="lg:flex justify-center items-center lg:space-x-5 lg:w-[800px] w-[380px] h-min-screen bg-transparent border shadow-2xl lg:py-10 lg:px-20 py-5 px-16 rounded-3xl z-50">
            ...
            <div class=" font-poppins lg:w-[380px] w-[250px] h-[400px] bg-white flex flex-col justify-center items-center space-y-7 rounded-lg lg:text-sm lg:p-5 p-2 text-xs">
            ...
            <div class=" lg:w-[350px] lg:h-[400px] lg:flex-col justify-center items-center flex flex-wrap space-y-3 lg:text-base text-xs lg:space-x-0 space-x-3">
                <div class=" flex justify-around items-center lg:py-4 lg:px-2 py-2 border bg-white rounded-xl shadow-lg mt-4 lg:w-[290px] w-[160px]">
