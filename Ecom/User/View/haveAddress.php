...
<body class="mt-3 font-poppins overflow-hidden">
    ...
    <main class="relative w-screen h-screen rounded-tl-[35px] rounded-tr-[35px] bg-purple-300">
        ...
        <div class=" flex-col space-y-5 w-[600px] justify-center items-center mx-auto">
            <div class=" addressCard">
                <img src="./resources/img/work.png" alt="...">
                <p>Tanitayi kawthaung, Zabinice 12 <br>
                    0921929191 </p>
                <img src="./resources/img/delivery_map_tracking.png" alt="...">
            </div>
            <div class=" addressCard">
