...
<body class="mt-3 font-Philosopher overflow-hidden dark:bg-black">
  ...
  <section class="relative">
    <section class="w-screen  h-screen rounded-tl-[5%] flex justify-center align-middle items-center  bg-gradient-to-tl from-[#d5a0e6] - to-[#9f80f4] dark:bg-linear_dark">
      <section class="flex flex-col items-center">
        <ion-icon class="text-9xl  dark:text-white" name="notifications-outline"></ion-icon>
        <p class="font-semibold text-3xl max-md:text-xl dark:text-white">NO Notification Here</p>
      </section>
    </section>
