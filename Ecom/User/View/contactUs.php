...
<body class="bg-white lg:bg-[#DDD4FF] relative overflow-hidden">
  <section class="lg:absolute lg:top-[21px] lg:left-[35px] flex justify-between items-center">
    <img class="w-32 ml-5 mt-5 lg:w-36" src="../../img/logo.png" />
    ...
    <section>
      <div class="lg:absolute h-screen w-full left-[620px] top-0 bg-white rounded-tl-[50px] rounded-bl-[50px]">
        <div class= "my-[20%] lg:my-[6%]">
          ...
          <p class="font-medium text-[15px] my-[7%] lg:my-[1%]  mx-[10%] lg:mx-[4%]">Name</p>
          <div class="my-[4%] lg:my-[2%] mx-[10%] lg:mx-[4%]"><input type="text" class="border border-b-black border-transparent w-[292px]"></div>

          <p class="font-medium text-[15px] my-[7%] lg:my-[1%]  mx-[10%] lg:mx-[4%]">Email</p>
          <div class="my-[4%] lg:my-[2%] mx-[10%] lg:mx-[4%]"><input type="text" class="border border-b-black border-transparent w-[292px]"></div>

          <p class="font-medium text-[15px] my-[7%] lg:my-[1%]  mx-[10%] lg:mx-[4%]">Message</p>
          <div class="my-[4%] lg:my-[2%] mx-[10%] lg:mx-[4%]"><input type="text" class="border border-b-black border-transparent w-[292px]"></div>
