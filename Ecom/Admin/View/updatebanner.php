        ...
        <div class="bg-white p7 flex flex-col float-left  items-center  rounded w-[100%] space-y-5">
            <div class="flex items-center">
                ...
                <div x-data="dataFileDnD()" class="relative w-[100%] flex flex-col p-4 text-gray-400 border border-black rounded">
                    <div x-ref="dnd" class="relative flex flex-col text-gray-400 border border-black border-dashed rounded cursor-pointer">
            ...
            <div class=" float-right ml-96">
                <button id="update" class="bg-blue-600 px-4 rounded-md py-2 text-white">Save</button>
            </div>
        </div>
    </div>
