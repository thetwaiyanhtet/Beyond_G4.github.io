        ...
        <div class="ml-16">
            ...
            <div class="p-5">
                ...
                <div class="flex justify-evenly items-center py-5">
                    ...
                    <p>-</p>
                    <input type="text" name="business" value="<?= $logoandname[0]['business_name']?>" class="flex w-[600px] h-[45px] rounded-lg border shadow-lg border-gray-400 items-center justify-center outline-none indent-2"
                    value="">
                </div>
            </div>
