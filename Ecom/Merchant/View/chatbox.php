...
<body>
    ...
    <main class="ml-56 w-auto h-auto relative">
        <p class="font-semibold text-lg pl-3 pt-3">Chat Box</p>
        <div class=" flex w-full h-full p-3 space-x-2">
            <!--Customer-->
            <div class=" text-white w-[325px] h-full border border-solid bg-gradient-to-b from-sky-500 via-gray-300 to-sky-800 rounded-lg space-y-3">
            ...
            <!--ChatBox-->
            <div class=" relative text-white w-full h-auto border border-solid bg-gradient-to-b from-sky-500 via-gray-300 to-sky-800 rounded-lg">
                <div class="w-full h-[70px] border-solid border-b-2 border-gray-900">
