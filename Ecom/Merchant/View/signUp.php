        ...
        <form action="">
            <div class="flex flex-col space-y-4 pt-14">
                ...
                <div class="text-[#667085]">
                    ...
                    <input type="text" class="w-[360px] h-[44px] border-[#d0d5dd67] border-2 rounded-md bg-white outline-none indent-2" placeholder="merchant###" required>
                </div>
                <div class="text-[#667085]">
                    <div>Email<span class=" text-red-600">*</span></div>
                    <input type="text" class="w-[360px] h-[44px] border-[#d0d5dd67] border-2 rounded-md bg-white outline-none indent-2" placeholder="merchant***@mail.com" required>
                </div>
