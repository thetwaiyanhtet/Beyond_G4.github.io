...
<body class=" font-poppins">
    <a href="./upgradeplan.php"><ion-icon name="arrow-back-outline" class="m-2 text-4xl p-3"></ion-icon></a>
    <form action="../Controller/upgradepaymentController.php" method="post" id="paymentForm">
