        ...
        <form action="">
            <div class="flex space-x-20 mt-2">
                <div class="flex flex-col">
                    ...
                    <input type="text" name="" id="" class="w-72 p-1 border border-solid  rounded-md mt-2">
                </div>
                <div class="flex flex-col">
            ...
            <div class="absolute right-[250px] top-0">
                <div class="flex-col">
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="" id="" class="w-72 p-2 border border-solid  rounded-md mt-2 font-medium " placeholder="Please enter New password">
                    </div>
                    <div class="flex flex-col">
                        <label for="" class="text-sm mt-2 ">Confirm New Password</label>
                        <input type="text" name="" id="" class="w-96 p-2 border border-solid rounded-md mt-2 font-medium " placeholder="Please re-enter the password to confirm">
                    </div>
                </div>
            </div>
        </form>
