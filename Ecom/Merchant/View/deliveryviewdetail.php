...
<body>
    <main class=" ml-60 h-screen">
        ...
        <div class="flex blur-sm justify-between mt-6 font-philosopher font-semibold text-2xl">
           Delivery
        </div>
        <div class="flex blur-sm justify-evenly max-lg:ml -ml-[30%] mt-3">
...
<div class="pt-2  relative mx-auto text-gray-600">
        ...
        <div class=" w-[98%] rounded-lg p-2 shadow-xl border-2 bg-gray-200  mt-3 ">
            <div class="relative  overflow-x-auto py-3">
                <table class="w-full blur-sm text-sm text-left text-gray-500 ">
                ...
                <div class="flex blur-sm justify-between items-center py-2 px-3">
                ...
                <div class=" max-lg:left-40 space-y-3 absolute top-14 left-80 p-4 shadow-lg rounded-md bg-gray-300 ">
                    <div>
                    ...
                    <button class="bg-blue-400 py-1 px-3 rounded-md mx-auto flex items-center">Cancel</button>
                </div>  
            </div>
