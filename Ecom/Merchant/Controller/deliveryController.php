...
$sql = $pdo->prepare(
    "SELECT m_customer.username,m_order.generate_id,m_order.order_date,m_order.total_amt,m_delivery.delivery_name,m_order_details.quantity,m_merchant.logo,m_product.sellprice as unit_price
    FROM m_customer 
    JOIN m_order
