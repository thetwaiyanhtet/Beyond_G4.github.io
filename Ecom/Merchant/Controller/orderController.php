...
$sql = $pdo->prepare(
    "SELECT m_order.generate_id,m_order_details.quantity,m_order_details.price_per_unit, m_customer.username, m_order.order_date, m_order.payment_status, m_order.payment_id
    FROM m_order
